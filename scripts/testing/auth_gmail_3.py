#!/usr/bin/env python3
"""
Authenticate gmail_3 account
Creates token file at tokens/gmail_account_3_token.json
"""
...
def main():
    """Authenticate gmail_3."""
    print("\n" + "="*70)
    print("Gmail Account 3 Authentication")
    print("="*70)
    print()
    ...
    try:
        ...
        print("⚠️  WICHTIG: Wähle im Browser das Konto: ebn.veranstaltungen.consulting@gmail.com")
        print()
